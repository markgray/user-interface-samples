...
class MainActivity : SampleActivityBase() {
     ...
     * and a `fragment` used for [LogFragment] with which of these children of the [ViewAnimator]
     * is displayed being toggled by our option menu, and layout-w720dp/activity_main.xml displays
     * both the sample description and a `fragment` used for [LogFragment] at the same time.
     *
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // TODO: Modify marginTop of scrollview here instead of in xml
