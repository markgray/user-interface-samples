 ...
 * This is the drop target for the `DragAndDropAcrossApps` and it contains an `ImageView` which will
 * accept and display a drawable which the user drags from the `DragSource` activity.
 */
class MainActivity : SampleActivityBase() {
     ...
     * `val transaction`, initialize our [DropTargetFragment] variable `val fragment` with a new
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            ...
            val fragment = DropTargetFragment()
