...
/**
 * This activity is displayed when the user clicks on the "See more" affordance at the bottom of
 * the grid slice. It simply displays the same content as the slice.
 */
class GridSliceActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_grid_slice)
    }
}
