...
class MainActivity : AppCompatActivity(),
     ...
     * view to our layout file `R.layout.activity_main` which just consists of a `LinearLayout`
     * root view holding a `FrameLayout` with resource ID `R.id.settings` into which we add
     * whichever fragment is called for.
     *
